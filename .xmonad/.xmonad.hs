...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    , ((modm, xK_i      ), spawn "terminal -I ~/.icons/irssi.png --title=irssi --command='screen -x -p irssi'")
    , ((modm, xK_p      ), spawn "terminal -I ~/.icons/alsamixer.png --command='alsamixer'")
...
main =
	xmonad defaults
	--xmproc <- spawnPipe "/usr/bin/tint2 /home/frostyx/.config/tint2/tint2rc"
